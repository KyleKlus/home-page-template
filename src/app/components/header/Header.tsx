...
import ScrollUpButton from '@/app/components/scrollUpButton/ScrollUpButton';
...
import HeaderNavigation from '@/app/components/header/headerNavigation/HeaderNavigation';
import Logo from './logo/Logo';
import SideNavigation from './sideNavigation/SideNavigation';

import sideNavStyles from './sideNavigation/SideNavigation.module.css'
